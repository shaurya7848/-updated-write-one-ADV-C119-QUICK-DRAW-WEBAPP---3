...
document.getElementById("sketch_to_be_drawn").innerHTML = "Sketech To Be Drawn : " + Element_of_array;
...
stroke(0);
if(mouseIsPressed){
    line(pmmouseX,pmmouseY,mouseX,mouseY);
}
check_sketch();
...
function check_sketch() {
    ...
    if(timer_counter>400){
        document.getElementById("your_sketch");
        timer_counter = 0;  
